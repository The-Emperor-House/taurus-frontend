        ...
        <div className="bg-white py-8 px-4 shadow-lg sm:rounded-xl sm:px-10">
          ...
          <form className="space-y-6" onSubmit={handleSubmit}>
            ...
            <button
              type="submit"
              disabled={isLoading}
              className={`w-full flex justify-center py-2 px-4 rounded-md text-white text-sm font-medium bg-[#cc8f2a] hover:bg-[#e0a040] focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#cc8f2a] transition duration-300 ${
