...
export default function AboutUs() {
  ...
  return (
    <Box sx={{ px: { xs: 2, md: 6 }, py: 4, maxWidth: '1200px', mx: 'auto' }}>
      <Grid container>
        {/* Left Section */}
        <Grid size={{ xs: 12, sm: 6 }} sx={{ mb: { xs: 4, sm: 0 } }}>
          <Box>
            <Typography variant="h4" fontWeight="light" gutterBottom>
              ABOUT US
            </Typography>
            ...
            <Typography variant="body2" sx={{ whiteSpace: 'pre-line' }}>
              ...
              สำนักงาน และอาคารทั่วไป รวมถึงงานระบบวิศวกรรม สถาปัตย์
              โดยทีมผู้เชี่ยวชาญในทุกสาขา ทั้งด้านงานออกแบบสถาปัตยกรรมและตกแต่งภายใน
              และระบบวิศวกรรม ภายใต้กระบวนการทำงานอย่างมืออาชีพ
              เพื่อร่วมขับเคลื่อน และควบคุมให้ได้ผลงานปลายทางตามมาตรฐาน
            </Typography>
        ...
        <Grid size={{ xs: 12, sm: 6 }} sx={{ mt: { xs: 4, sm: 0 } }}>
          <Box>
            ...
            <Stack direction="row" spacing={1} mb={2} flexWrap="wrap">
              <Button variant="outlined" startIcon={<HomeIcon />} sx={{ mb: 1 }}>
                สร้างใหม่
              </Button>
              <Button variant="outlined" startIcon={<BuildIcon />} sx={{ mb: 1 }}>
                ต่อเติม - ซ่อมแซม
              </Button>
              <Button variant="outlined" startIcon={<DesignServicesIcon />} sx={{ mb: 1 }}>
                ออกแบบตกแต่งภายใน
              </Button>
            </Stack>
